...
func.func @test_valid_single_value(%cond: i1, %true: f32, %false: f32) {
  %0 = "orchestra.commit"(%cond, %true, %false) <{num_true = 1 : i32}> : (i1, f32, f32) -> f32
  return
}
...
func.func @test_valid_multiple_values(%cond: i1, %t1: f32, %t2: tensor<4xf32>, %f1: f32, %f2: tensor<4xf32>) {
  %0, %1 = "orchestra.commit"(%cond, %t1, %t2, %f1, %f2) <{num_true = 2 : i32}> : (i1, f32, tensor<4xf32>, f32, tensor<4xf32>) -> (f32, tensor<4xf32>)
  return
}
...
func.func @test_valid_zero_values(%cond: i1) {
  "orchestra.commit"(%cond) <{num_true = 0 : i32}> : (i1) -> ()
  return
}
...
func.func @test_invalid_mismatched_true_false_count(%cond: i1, %t1: f32, %f1: f32, %f2: f32) {
  ...
  %0 = "orchestra.commit"(%cond, %t1, %f1, %f2) <{num_true = 1 : i32}> : (i1, f32, f32, f32) -> f32
  return
}
...
func.func @test_invalid_mismatched_true_false_types(%cond: i1, %t1: f32, %f1: i32) {
  ...
  %0 = "orchestra.commit"(%cond, %t1, %f1) <{num_true = 1 : i32}> : (i1, f32, i32) -> f32
  return
}
...
func.func @test_invalid_mismatched_result_count(%cond: i1, %t1: f32, %f1: f32) {
  ...
  %0, %1 = "orchestra.commit"(%cond, %t1, %f1) <{num_true = 1 : i32}> : (i1, f32, f32) -> (f32, f32)
  return
}
...
func.func @test_invalid_mismatched_result_types(%cond: i1, %t1: f32, %f1: f32) {
  ...
  %0 = "orchestra.commit"(%cond, %t1, %f1) <{num_true = 1 : i32}> : (i1, f32, f32) -> i32
  return
}
